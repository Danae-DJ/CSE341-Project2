...
const getAllOrders = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: err.message || 'Some error occurred getting orders.' });
  }
};
...
const createOrder = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: err.message || 'Some error occurred while creating the order.' });
  }
};
...
const deleteOrder = async (req, res) => {
  ...
  try {
    ...
    res.status(500).json({ message: err.message || 'Some error occurred while deleting the order.' });
  }
};
